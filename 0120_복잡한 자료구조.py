...
road = data[0]['results'][0]['properties']

first_data = {}
first_data['제목']=road['제목']['title'][0]['plain_text']
first_data['일차']=int(road['일차']['number'])
first_data['단계']=str(road['단계']['select']['name'])+str('단계')
first_data['과목']=road['과목']['multi_select'][0]['name']
print(first_data)